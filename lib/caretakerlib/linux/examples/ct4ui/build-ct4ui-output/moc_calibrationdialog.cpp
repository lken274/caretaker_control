...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CalibrationDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 72, 14)
    ...
    "CalibrationDialog\0cdExit\0\0status\0"
    "cdCancel\0cdAuto\0cdManual\0onPostureLeft\0"
    "onPostureRight\0"
};
...
void CalibrationDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->cdExit((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->cdCancel(); break;
        case 2: _t->cdAuto(); break;
        case 3: _t->cdManual(); break;
        case 4: _t->onPostureLeft(); break;
        case 5: _t->onPostureRight(); break;
        default: ;
        }
        ...
        {
            typedef void (CalibrationDialog::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CalibrationDialog::cdExit)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void CalibrationDialog::cdExit(int _t1)
{
